...
class ColorValues {
  ...
  static const Color TEXT_COLOR1 = const Color(0xFF8069D4);
  static const Color card = const Color(0xFFF2F2F2);
  static const Color TEXT_FIELD_BACKGRAUND = const Color(0xFFF6F9FF);
